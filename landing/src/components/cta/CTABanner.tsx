...
function CTAButton({ href, label, icon: Icon, external, variant }: CTAButtonProps) {
  const variants = {
    primary: 'btn-primary',
  ...
  return (
    ...
    >
      ...
      {label}
      {external && <ExternalLink className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" aria-hidden="true" />}
    </a>
  )
}
      ...
      <Container className="relative">
        ...
        >
          ...
          <p className="section-subtitle mx-auto">
            Join thousands of security researchers using PhoneSploit Pro. Star the repo, report issues, or start a discussion.
          </p>
